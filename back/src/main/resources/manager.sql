...
-- ----------------------------
INSERT INTO `class`
VALUES (1, 2020, 2002, '备注1');
INSERT INTO `class`
VALUES (2, 2020, 2003, '备注2');
INSERT INTO `class`
VALUES (3, 2020, 2008, '备注3');
INSERT INTO `class`
VALUES (4, 2020, 2004, '备注4');
INSERT INTO `class`
VALUES (5, 2020, 2005, '备注5');
...
(
  ...
  AUTO_INCREMENT = 6
  CHARACTER SET = utf8
  COLLATE = utf8_general_ci COMMENT = '课程表'
  ROW_FORMAT = Dynamic;
...
(
  ...
  AUTO_INCREMENT = 6
  CHARACTER SET = utf8
  COLLATE = utf8_general_ci COMMENT = '下载记录'
  ROW_FORMAT = Dynamic;
...
VALUES (1, 5, 3, '2024-02-09 16:35:00');
INSERT INTO `download`
VALUES (2, 5, 2, '2024-02-10 00:47:09');
INSERT INTO `download`
VALUES (3, 5, 4, '2024-02-11 06:19:52');
...
(
  ...
  AUTO_INCREMENT = 6
  CHARACTER SET = utf8
  COLLATE = utf8_general_ci COMMENT = '文件评论'
  ROW_FORMAT = Dynamic;
...
VALUES (1, 3, 3, '评论1', NULL, '2024-02-11 16:35:00', 892);
INSERT INTO `file_comment`
VALUES (2, 3, 3, '评论2', NULL, '2024-02-12 00:47:09', 57);
INSERT INTO `file_comment`
VALUES (3, 3, 4, '评论3', 1, '2024-02-13 06:19:52', 598);
INSERT INTO `file_comment`
VALUES (4, 3, 2, '评论4', 1, '2024-02-15 04:07:16', 476);
INSERT INTO `file_comment`
VALUES (5, 3, 1, '评论5', NULL, '2024-02-16 22:07:19', 761);
...
(
  ...
  AUTO_INCREMENT = 6
  CHARACTER SET = utf8
  COLLATE = utf8_general_ci COMMENT = '评级信息'
  ROW_FORMAT = Dynamic;

-- ----------------------------
-- Records of file_star
-- ----------------------------
INSERT INTO `file_star`
VALUES (1, 4, 3, 4);
INSERT INTO `file_star`
VALUES (2, 3, 3, 3);
INSERT INTO `file_star`
...
(
  ...
  AUTO_INCREMENT = 6
  CHARACTER SET = utf8
  COLLATE = utf8_general_ci COMMENT = '文件'
  ROW_FORMAT = Dynamic;
...
-- ----------------------------
INSERT INTO `flie`
VALUES (1, 1, 1, '文件名1', '类型1', '标签1', '隐私程度1', NULL, '版本1', '2024-02-09 16:35:00', b'0');
INSERT INTO `flie`
VALUES (2, 1, 1, '文件名2', '类型2', '标签2', '隐私程度2', NULL, '版本1', '2024-02-10 00:47:09', b'0');
INSERT INTO `flie`
VALUES (3, 1, 1, '文件名3', '类型3', '标签3', '隐私程度3', NULL, '版本1', '2024-02-11 06:19:52', b'0');
INSERT INTO `flie`
VALUES (4, 1, 1, '文件名1', '类型1', '标签4', '隐私程度4', NULL, '版本2', '2024-02-13 04:07:16', b'0');
INSERT INTO `flie`
VALUES (5, 1, 1, '文件名1', '类型1', '标签5', '隐私程度5', NULL, '版本3', '2024-02-14 22:07:19', b'0');
...
-- ----------------------------
INSERT INTO `floder`
VALUES (1, '目录1', NULL, 1, '2024-02-11 16:35:00');
INSERT INTO `floder`
VALUES (2, '目录2', NULL, 1, '2024-02-12 00:47:09');
INSERT INTO `floder`
VALUES (3, '目录1.1', 1, 1, '2024-02-13 06:19:52');
INSERT INTO `floder`
VALUES (4, '目录3', NULL, 1, '2024-02-15 04:07:16');
INSERT INTO `floder`
VALUES (5, '目录2.1', 2, 1, '2024-02-16 22:07:19');
...
(
  ...
  AUTO_INCREMENT = 9
  CHARACTER SET = utf8
  COLLATE = utf8_general_ci COMMENT = '关注表'
  ROW_FORMAT = Dynamic;
...
-- ----------------------------
INSERT INTO `follow`
VALUES (1, 2, 1, '2024-02-09 16:35:00');
INSERT INTO `follow`
VALUES (2, 3, 1, '2024-02-10 00:47:09');
INSERT INTO `follow`
VALUES (3, 4, 1, '2024-02-11 06:19:52');
INSERT INTO `follow`
VALUES (4, 5, 1, '2024-02-13 04:07:16');
INSERT INTO `follow`
VALUES (5, 1, 3, '2024-02-13 04:07:16');
...
(
  ...
  AUTO_INCREMENT = 6
  CHARACTER SET = utf8
  COLLATE = utf8_general_ci COMMENT = '登录信息'
  ROW_FORMAT = Dynamic;
...
VALUES (1, 1, '2024-02-08 16:35:00', 'ip地址1', '设备信息1');
INSERT INTO `login_info`
VALUES (2, 1, '2024-02-09 00:47:09', 'ip地址2', '设备信息2');
INSERT INTO `login_info`
VALUES (3, 1, '2024-02-10 06:19:52', 'ip地址3', '设备信息3');
INSERT INTO `login_info`
VALUES (4, 2, '2024-02-12 04:07:16', 'ip地址4', '设备信息4');
INSERT INTO `login_info`
VALUES (5, 3, '2024-02-13 22:07:19', 'ip地址5', '设备信息5');
...
-- ----------------------------
INSERT INTO `menu`
VALUES (1, '首页', '/home/home', 'home', 0);
INSERT INTO `menu`
VALUES (2, '系统管理', '/home/systemSet', 'systemSet', 0);
INSERT INTO `menu`
VALUES (3, '路由存储管理', '/home/systemSet/routes', 'routes', 2);
INSERT INTO `menu`
VALUES (4, '字典存储管理', '/home/systemSet/dictsset', 'dictsset', 2);
INSERT INTO `menu`
VALUES (5, '部门管理', '/home/systemSet/department', 'department', 2);
INSERT INTO `menu`
VALUES (6, '角色配置', '/home/systemSet/page1', 'page1', 2);
INSERT INTO `menu`
VALUES (7, '用户管理', '/home/systemSet/userset', 'userset', 2);
INSERT INTO `menu`
VALUES (8, '权限页面分配', '/home/systemSet/pagerootsettip', 'pagerootsettip', 2);
INSERT INTO `menu`
VALUES (9, '数据查看', '/home/page1b', 'page1b', 0);
INSERT INTO `menu`
VALUES (10, '关于本站弹窗管理', '/home/page1b/subpage1b', 'subpage1b', 9);
INSERT INTO `menu`
VALUES (11, '导航分级', '/home/page1b2', 'page1b2', 0);
INSERT INTO `menu`
VALUES (12, '导航二级', '/home/page1b2/subpage1b2', 'subpage1b2', 11);
INSERT INTO `menu`
VALUES (13, '导航三级', '/home/page1b2/subpage1b2/subpage1b2s', 'subpage1b2s', 12);
INSERT INTO `menu`
VALUES (14, '更多图标展示', '/home/icons', 'icons', 0);
INSERT INTO `menu`
VALUES (15, '个人资料', '/home/personal', 'personal', 0);
INSERT INTO `menu`
VALUES (16, '设置', '/home/setting', 'setting', 0);
...
(
  ...
  CHARACTER SET = utf8
  COLLATE = utf8_general_ci COMMENT = '公告'
  ROW_FORMAT = Dynamic;
...
-- ----------------------------
INSERT INTO `notice`
VALUES (1, 2, '公告名称1', '内容1', '2024-02-10 16:35:00', '2024-02-11 16:35:00');
INSERT INTO `notice`
VALUES (2, 2, '公告名称2', '内容2', '2024-02-11 00:47:09', '2024-02-12 00:47:09');
INSERT INTO `notice`
VALUES (3, 2, '公告名称3', '内容3', '2024-02-12 06:19:52', '2024-02-13 06:19:52');
INSERT INTO `notice`
VALUES (4, 2, '公告名称4', '内容4', '2024-02-14 04:07:16', '2024-02-15 04:07:16');
INSERT INTO `notice`
VALUES (5, 2, '公告名称5', '内容5', '2024-02-15 22:07:19', '2024-02-16 22:07:19');
...
-- ----------------------------
INSERT INTO `role`
VALUES (1, '学生', '0', NULL, 1);
INSERT INTO `role`
VALUES (2, '老师', '0', NULL, 2);
INSERT INTO `role`
VALUES (3, '超级管理员', '0', NULL, 0);
...
(
  ...
  AUTO_INCREMENT = 6
  CHARACTER SET = utf8
  COLLATE = utf8_general_ci COMMENT = '权限菜单展示表'
  ROW_FORMAT = Dynamic;
...
(
  ...
  AUTO_INCREMENT = 6
  CHARACTER SET = utf8
  COLLATE = utf8_general_ci COMMENT = '课程安排关系表'
  ROW_FORMAT = Dynamic;
...
(
  ...
  AUTO_INCREMENT = 8
  CHARACTER SET = utf8
  COLLATE = utf8_general_ci COMMENT = '学生班级表'
  ROW_FORMAT = Dynamic;
...
-- ----------------------------
INSERT INTO `user`
VALUES (1, 'patricia_mfey', '密码1', '昵称1', '头像1', '13209858103', '男', 37, '简介1', 'helen83@linkedin.com',
        '组织/机构1', '2024-02-13 15:11:58', b'0', 1, 1, '伍云云', '124325198505031532', '研究方向1');
INSERT INTO `user`
VALUES (2, 'charles_9fkl', '密码2', '昵称2', '头像2', '13360707300', '女', 55, '简介2', 'sarah19@github.com',
        '组织/机构2', '2024-02-13 16:35:00', b'0', 1, 1, '郑彬昱', '123016200305210859', '研究方向2');
INSERT INTO `user`
VALUES (3, 'paul_km', '密码3', '昵称3', '头像3', '13727353390', '女', 63, '简介3', 'james30@adobe.com', '组织/机构3',
        '2024-02-14 00:47:09', b'0', 1, 1, '余霞欣', '363685197212040521', '研究方向3');
INSERT INTO `user`
VALUES (4, 'david_snh', '密码4', '昵称4', '头像4', '13539400338', '女', 35, '简介4', 'lisa4@w3.org', '组织/机构4',
        '2024-02-15 06:19:52', b'0', 1, 1, '苏雅莉', '112500197108040217', '研究方向4');
INSERT INTO `user`
VALUES (5, 'elizabeth_9jaqmf', '密码5', '昵称5', '头像5', '13918573633', '女', 54, '简介5', 'linda17@blogspot.com',
        '组织/机构5', '2024-02-17 04:07:16', b'0', 1, 2, '许青', '534922199308020951', '研究方向5');
INSERT INTO `user`
VALUES (6, 'admin', 'admin', '管理员', NULL, NULL, NULL, NULL, NULL, 'admin@qq.com', NULL, '2024-04-20 10:57:51', b'0',
        0, 1, NULL, NULL, NULL);
...
(
  ...
  AUTO_INCREMENT = 6
  CHARACTER SET = utf8
  COLLATE = utf8_general_ci COMMENT = '查看记录'
  ROW_FORMAT = Dynamic;
...
-- ----------------------------
INSERT INTO `view`
VALUES (1, 4, 1, '2024-02-09 16:35:00');
INSERT INTO `view`
VALUES (2, 4, 1, '2024-02-10 00:47:09');
INSERT INTO `view`
VALUES (3, 4, 2, '2024-02-11 06:19:52');
INSERT INTO `view`
VALUES (4, 4, 2, '2024-02-13 04:07:16');
INSERT INTO `view`
VALUES (5, 4, 3, '2024-02-14 22:07:19');
