<template>
    <div style="position:relative">
        ...
        <!-- 弹窗 - 通知 -->
        <el-dialog v-model="showmsg" align-center="true" title="通知">
            <msgVue />
        </el-dialog>
    </div>
</template>
